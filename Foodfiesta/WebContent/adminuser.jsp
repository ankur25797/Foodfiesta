	...
	<form action='EditAdmin' method=post>
		...
		<div class="col-md-3">
			<div class="form-group">
					<label>Full Name</label> <input name='adminname' type="text"
			...
			<div class="col-md-4">
				<div class="form-group">
					<label for="exampleInputEmail1">Email address</label> <input
						...
						placeholder="Email" value='<%= A.getEmail() %>'>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-6">
				...
				<button name='btn' type="submit"	class="btn btn-info btn-fill pull-right" vaule='Update'>Update
					Profile</button>
...
<div class="col-md-4">
	<div class="card card-user">
		...
		<div class="content">
			<div class="author">
				<a href="#"> <img class="avatar border-gray" src="assets/images/<%= A.getPicture() %>"
					alt="..." />

					<h4 class="title">
					<%= A.getAdminName() %>	<br /> <small>michael24</small>
					</h4>
				</a>
			</div>
			<p class="description text-center">
				...
				<form action="EditPicture" method=post>
					...
					<button name='btn' type="submit"	class="btn btn-info btn-fill pull-right" >Submit</button>
				</form>
		</div>
		<hr>
		<div class="text-center">
			...
			<div class="container-fluid">
				...
				<p class="copyright pull-right">
					...
					<a href="http://www.creative-tim.com"><%= A.getAdminName() %></a>, made with
