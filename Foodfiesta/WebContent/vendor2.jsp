	...
	<div class="form">
		...
		<div class="tab-content">
			<div id="login">
				...
				<form action="CheckVendorLogin" method="post">
			...
			<div id="signup">
				...
				<form action="VendorRegSubmit" method="post"
					enctype='multipart/form-data'>


					<div class="field-wrap">
						<label> Name<span class="req">*</span>
						</label> <input type="text" id=name name=name required autocomplete="off" />
					</div>
					...
					<div class="field-wrap">
						...
						</label> <input type="text" id=address name=address required
							autocomplete="off" />
					</div>

					<div class="field-wrap">
						<label> Contact Number<span class="req">*</span>
						</label> <input type="integer" id=mob name=mob required autocomplete="off" />
					</div>

					<div class="field-wrap">
						<label> State&nbsp;<span class="req"></span>
						</label> <select id=state name=state><option>-State-</option></select>
					</div>

					<div class="field-wrap">
						<label> City&nbsp;<span class="req"></span>
						</label> <select id=city name=city><option>-City-</option></select>
					</div>
					...
					<div class="field-wrap">
						<label> Id Proof<span class="req">*</span>
						</label> <input type="file" id=idproof name=idproof required
							autocomplete="off" />
					</div>

					<button type="submit" class="button button-block" id=start />
					Get Started
					</button>
					<span id=mess></span>
